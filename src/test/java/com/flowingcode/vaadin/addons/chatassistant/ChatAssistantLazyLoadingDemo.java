...
public class ChatAssistantLazyLoadingDemo extends VerticalLayout {
  ...
  public ChatAssistantLazyLoadingDemo() {
    // Backing message list, served lazily by the data provider below.
    List<Message> messages = createMessages();

    // Create the assistant; the "small" class shrinks the message font (see demo CSS).
    ...
    // Feed messages through a lazy DataProvider, reporting the requested page as it loads.
    Span lazyLoadingData = new Span();
    DataProvider<Message, ?> dataProvider =
        DataProvider.fromCallbacks(
            query -> {
              lazyLoadingData.setText(
    ...
    // Replace the default header with a custom title bar and minimize button.
    ...
    // With a custom DataProvider, append to the list and refresh instead of using sendMessage.
    ...
    // Messages typed in the chat input are appended the same way.
  ...
  /** Sample conversation (an excerpt from Hamlet) used to populate the lazy data provider. */
  private static List<Message> createMessages() {
    return new ArrayList<>(
        Arrays.asList(
            ...
            Message.builder()
                .name("Rosencrantz")
                .content("Without, my lord; guarded, to know your pleasure.")
                .build(),
            Message.builder().name("Claudius").content("Bring him before us.").build(),
            Message.builder()
                .name("Rosencrantz")
                .content("Ho, Guildenstern! Bring in my lord.")
                .build(),
            ...
            Message.builder()
                .name("Claudius")
                .content("So is it, if thou knew'st our purposes.")
                .build(),
            Message.builder()
                .name("Hamlet")
                .content(
